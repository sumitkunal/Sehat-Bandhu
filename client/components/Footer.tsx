        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'About Us', 'Services', 'Find Doctors', 'Medicines', 'Contact Us'].map((text, idx) => (
                <li key={idx}>
                  <Link to="/" className="text-gray-400 hover:text-white transition-colors">{text}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/appointments" className="text-gray-400 hover:text-white transition-colors">Appointment Booking</Link></li>
              <li><Link to="/medicines" className="text-gray-400 hover:text-white transition-colors">Ayurvedic Medicines</Link></li>
              <li><Link to="/messages" className="text-gray-400 hover:text-white transition-colors">Doctor Consultations</Link></li>
              <li><Link to="/news" className="text-gray-400 hover:text-white transition-colors">Health News</Link></li>
